      ...
      <div className='col-4'>
        <aside className="main-sidebar sidebar-dark-primary elevation-4" style={rosa}>
          <div className='text-center'>
            <a href="./Home.jsx" className="brand-link">
